#!/usr/bin/env python3
"""
Build 114 natural answer-card question bank.
...
RAW_DIR = ROOT / "data/raw-extract/114學年度/自然"
PDF = ROOT / "資料/大考中心官方PDF/114學年度/自然/114學測-自然-試題內容-114學測自然試題定稿.pdf"
ANSWER_JSON = RAW_DIR / "114學測-自然-選擇題答案-06-114學測自然答案.json"
OUT_JS = ROOT / "src/question-bank/114-natural.js"
IMAGE_DIR = ROOT / "public/images/114學年度/自然"
IMAGE_PREFIX = "public/images/114學年度/自然"
...
BLOCK_SPECS = [
    {"id": "nature-114-p02-q01-05", "title": "第 1-5 題", "questionNos": [1, 2, 3, 4, 5],
     "crops": [(2, FULL)]},
    {"id": "nature-114-p03-q06-08", "title": "第 6-8 題", "questionNos": [6, 7, 8],
     "crops": [(3, FULL)]},
    {"id": "nature-114-p04-q09-13", "title": "第 9-13 題", "questionNos": [9, 10, 11, 12, 13],
     "crops": [(4, FULL)]},
    {"id": "nature-114-p05-q14-15", "title": "第 14-15 題", "questionNos": [14, 15],
     "crops": [(5, FULL)]},
    {"id": "nature-114-p06-q16-19", "title": "第 16-19 題", "questionNos": [16, 17, 18, 19],
     "crops": [(6, FULL)]},
    {"id": "nature-114-p07-q20-24", "title": "第 20-24 題", "questionNos": [20, 21, 22, 23, 24],
     "crops": [(7, FULL)]},
    {"id": "nature-114-p08-q25-27", "title": "第 25-27 題", "questionNos": [25, 26, 27],
     "crops": [(8, FULL)]},
    {"id": "nature-114-p09-q28-29", "title": "第 28-29 題", "questionNos": [28, 29],
     "crops": [(9, FULL)]},
    {"id": "nature-114-p10-q30-33", "title": "第 30-33 題", "questionNos": [30, 31, 32, 33],
     "crops": [(10, FULL)]},
    {"id": "nature-114-p11-q34-36", "title": "第 34-36 題", "questionNos": [34, 35, 36],
     "crops": [(11, FULL)]},
    {"id": "nature-114-p12-p13-q37-39", "title": "第 37-39 題題組", "questionNos": [37, 38, 39],
     "crops": [(12, FULL), (13, FULL)]},
    {"id": "nature-114-p14-p15-q40-43", "title": "第 40-43 題題組", "questionNos": [40, 41, 42, 43],
     "crops": [(14, FULL), (15, (48, 74, 548, 332))]},
    {"id": "nature-114-p15-p16-q44-46", "title": "第 44-46 題題組", "questionNos": [44, 45, 46],
     "crops": [(15, (48, 332, 548, 792)), (16, (48, 74, 548, 688))]},
    {"id": "nature-114-p16-p17-q47-49", "title": "第 47-49 題題組", "questionNos": [47, 48, 49],
     "crops": [(16, (48, 688, 548, 792)), (17, FULL)]},
    {"id": "nature-114-p18-p19-q50-54", "title": "第 50-54 題題組", "questionNos": [50, 51, 52, 53, 54],
     "crops": [(18, FULL), (19, FULL)]},
    {"id": "nature-114-p20-q55-57", "title": "第 55-57 題題組", "questionNos": [55, 56, 57],
     "crops": [(20, FULL)]},
]
...
def build_question(no, raw):
    question = {
        "id": f"natural-114-{'hw-' if raw == '／' else ''}q{no}",
        "no": no,
...
def build_bank():
    ...
    return {
        ...
        "status": "官方 PDF 提取題庫",
        "source": {
            "試題": "資料/大考中心官方PDF/114學年度/自然/114學測-自然-試題內容-114學測自然試題定稿.pdf",
            "答案": "資料/大考中心官方PDF/114學年度/自然/114學測-自然-選擇題答案-06-114學測自然答案.pdf",
        },
        "note": (
            f"收錄 114 學測自然選擇題共 {len(gradable)} 題；另列手寫題 {len(handwritten)} 題"
...
def main():
    bank = build_bank()
    OUT_JS.write_text(
        "// 由 tools/build_natural_114.py 自動產生，請勿手改。題目與答案取自官方 PDF，未經改寫。\n"
        "QUESTION_BANKS.push(\n"
